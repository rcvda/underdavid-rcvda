...
<head>
	...
	<link rel="preload" as="image"
		href="/wp-content/uploads/2023/07/RCVDA-Logo-without-Text-White-Outline-768x157-1.webp" async>

	<!--  Preload Fonts -->
	<link rel="preload" href="/wp-content/themes/underdavid-rcvda/fonts/Raleway-SemiBold.ttf" as="font" type="font/ttf"
		crossorigin="anonymous" async>
	<link rel="preload" href="/wp-content/themes/underdavid-rcvda/fonts/FiraSans-ExtraBold.ttf" as="font"
		type="font/ttf" crossorigin="anonymous" async>
	...
	<!-- 	Preload Font Awsome -->
	<link async rel="preload" href="/wp-content/themes/underdavid-rcvda/fonts/fontawesome-free-6.7.2-web/js/all.js"
		as="script" />

	<!-- 	Preload Favicon? -->
	<link rel="preload" as="image" media=”all”
		href="/wp-content/uploads/2023/07/cropped-RCVDA-Favicon-White-Border-32x32.webp" async>
	...
	<div class="site" id="page">
		...
		<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
			...
			<nav class="navbar navbar-collapse navbar-dark bg-primary" style="flex-flow: column;">
				...
				<div class="container">
					...
					<div class="col-lg-10">
						<div id="buttonz" style="display: flex; justify-content: right;">
							<button class="menu1" id="tglBtn1" type="button" data-bs-toggle="collapse"
								data-bs-target="#navbarNavDropdown1" aria-controls="navbarNavDropdown"
								aria-expanded="false" onclick="choice1()"
								aria-label="<?php esc_attr_e('Toggle navigation', 'understrap'); ?>" style="border-bottom-color: #1A223E;
								   border-bottom-width: thick;
								   border-bottom-style: solid;">
								About
							</button>

							<button class="menu2" id="tglBtn2" type="button" data-bs-toggle="collapse"
								data-bs-target="#navbarNavDropdown2" aria-controls="navbarNavDropdown"
								aria-expanded="false" onclick="choice1()"
								aria-label="<?php esc_attr_e('Toggle navigation', 'understrap'); ?>" style="border-bottom-color: #154284;
								   border-bottom-width: thick;
								   border-bottom-style: solid;">
								Our Work
							</button>

							<button class="menu3" id="tglBtn3" type="button" data-bs-toggle="collapse"
								data-bs-target="#navbarNavDropdown3" aria-controls="navbarNavDropdown"
								aria-expanded="false" onclick="choice1()"
								aria-label="<?php esc_attr_e('Toggle navigation', 'understrap'); ?>" style="border-bottom-color: #DA1E19;
								   border-bottom-width: thick;
								   border-bottom-style: solid;">
								Contact
							</button>
				...
				<div id="menuContainer1" class="container"
					style="background-color:#1A223E; background-clip: content-box;">
				...
				<div id="menuContainer2" class="container"
					style="background-color:#154284; background-clip: content-box;">
					<ul id="buttonbox" style="padding-left:0px; margin-bottom: 0px;">
				...
				<div id="menuContainer3" class="container"
					style="background-color:#DA1E19; background-clip: content-box;">
					<ul id="buttonbox" style="padding-left:0px; margin-bottom: 0px;">
