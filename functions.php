	...
	if (is_user_logged_in()) {
		...
		<div class="wrap">
			<p>Site commissioned from RCVDA&nbsp;/&nbsp;Designed by
				...
				<a rel="nofollow" href=<?php echo get_site_url() . '/wp-login.php?action=logout&amp;_wpnonce=5969d1c9bc' ?>>Log
					out
				</a>
			</p>
		</div>
		...
		<div class="wrap">
			<p>Site commissioned from RCVDA&nbsp;/&nbsp;Designed by
				...
				<a rel="nofollow" href=<?php echo get_site_url() . '/wp-login.php' ?>>Log in
				</a>
			</p>
		</div>
		<?php
